...
export function serializeEquipmentSlotDefinitions(itSlDefinitions: EquipmentSlotDefinition[]): EquipmentSlotDefinitionsDTO {
    return { arr: itSlDefinitions.map((def) => serializeEquipmentSlotDefinition(def)) }
}
export function deserializeEquipmentSlotDefinitions(itSlDefinitionsDTO: EquipmentSlotDefinitionsDTO): EquipmentSlotDefinition[] {
